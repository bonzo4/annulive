  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.ok && result.roadmap) {
        ...
        console.error("Error generating trunk track:", errorMessage);

        if (onError) {
          onError(errorMessage);
        } else {
          alert(`Failed to create trunk track: ${errorMessage}`);
        }
      }
    } catch (error) {
      const errorMessage =
    ...
    <div className="mx-auto max-w-2xl rounded-2xl bg-white p-8 shadow-xl">
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-bold text-gray-900">
          Create Your Learning Trunk Track
        </h2>
        ...
        <div className="mt-4 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
          <p className="text-sm text-yellow-800">
            <strong>Disclaimer:</strong> This trunk track is generated by AI and
            may contain inaccurate information. Please verify resources and
          ...
          >
            {isSubmitting ? (
              <>
                ...
                Creating Trunk Track...
              </>
            ) : (
              "Create My Trunk Track"
            )}
          </Button>
        </div>
      </form>
